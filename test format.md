...
classDiagram
    ...
    class ExamSession {
        ...
        +start_time: DateTime
        +end_time: DateTime
        +status: Enum[InProgress, Completed, Timed_Out]
        +score: Float
    ...
    class QuestionBase {
        ...
        +question_text: Text
        +points: Float
        +type: Enum[MCQ, Coding, Marketing]
        +order: Integer
    }
    ...
    User "1" -- "*" ExamSession : takes
    User "1" -- "*" Exam : creates
    Exam "1" -- "*" QuestionBase : contains
    QuestionBase <|-- MCQQuestion : extends
    QuestionBase <|-- CodingQuestion : extends
    QuestionBase <|-- MarketingQuestion : extends
    ExamSession "1" -- "*" StudentResponse : includes
    QuestionBase "1" -- "*" StudentResponse : answers
